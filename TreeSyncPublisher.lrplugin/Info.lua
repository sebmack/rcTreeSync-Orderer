...
return {
    ...
    shortAppName = "TSP",
    author = "Rob Cole & Seb Mackinnon",
    authorsWebsite = "https://github.com/sebmack/rcTreeSync-Orderer",
    donateUrl = "",
    platforms = { 'Windows', 'Mac' },
    pluginId = "com.robcole.lightroom.TreeSyncPublisher",
    -- xmlRpcUrl removed - Rob Cole's server no longer exists
    -- LrPluginName = "rc TreeSync Publisher",
    LrPluginName = LOC "$$$/rcTreeSyncPublisher/PluginName=rc TreeSync Publisher",
    LrSdkMinimumVersion = 3.0,
    LrSdkVersion = 5.0,
    LrPluginInfoUrl = "https://github.com/sebmack/rcTreeSync-Orderer",
    ...
    --     },
    -- },
    VERSION = { display = "12.0    Build: 2026-06-30" },
}
